                    ...
                    <div className={styles.scrollComponent}>
                        ...
                        <div className={styles.wrapper}>
                            <div className={styles.createPostContainer}>
                                ...
                                <textarea onChange={(e) => setPostContent(e.target.value)} value={postContent} className={styles.textareaOfContent} placeholder="What in your mind?" id=""></textarea>
                                    ...
                                    return (
                                        <div key={post._id} className={styles.singleCard}>
                                            ...
                                            <div className={styles.singleCard_profileContainer}>
                                                ...
                                                <img className={styles.singleCard_image} src={`${BASE_URL}/${authState.user?.userId?.profilePicture}`} alt="" />
                                                    ...
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1.2rem', justifyContent: 'space-between' }}>
                                                        ...
                                                        {post.userId._id === authState.user?.userId?._id &&
                                                            <div onClick={async () => {
                                                                ...
                                                                <svg style={{ height: '1.45rem', color: 'red' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                    ...
                                                    <div className={styles.optionContainer}>
                                                        ...
                                                        <div
                                                            onClick={async () => {
                                                                ...
                                                                dispatch(incrementPostLikes({ post_id: post._id }));
                                                                dispatch(getAllPosts());
                                                        ...
                                                        <div
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                const url = encodeURIComponent(" this is the post of " + (post.userId.name));
